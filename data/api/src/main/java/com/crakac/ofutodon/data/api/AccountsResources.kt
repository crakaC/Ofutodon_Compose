...
//        @Query("tagged") // Added in v2.8.0
    ...
    @GET("/api/v1/filters")
    suspend fun getAllFilters(): List<com.crakac.ofutodon.data.entity.Filter>
    ...
    suspend fun getFeaturedTags(): List<com.crakac.ofutodon.data.entity.FeaturedTag>
    ...
    suspend fun getPreferences(): com.crakac.ofutodon.data.entity.Preferences
